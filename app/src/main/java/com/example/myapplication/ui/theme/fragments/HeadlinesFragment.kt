...
import com.example.myapplication.databinding.FragmentHeadlinesBinding
...
import com.example.myapplication.util.Constant.Companion.SEARCH_NEWS_TIME_DELAY
...
class HeadlinesFragment : Fragment(R.layout.fragment_headlines) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener { article ->
            ...
            findNavController().navigate(R.id.action_headlinesFragment_to_newsDetailsFragment, bundle)
        }
